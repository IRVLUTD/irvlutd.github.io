...
Appendix C contains the full 90-variant list. It includes five ID variants and five OOD variants for
most tasks, with no OOD variants for Tasks 5 and 6.

## Reference scene images

Appendix E contains the 90 reference images used to set up the evaluation scenes. Use these images
to match the task layout before starting the policy.
